...
import { Mail, Lock, User, Loader2, ArrowRight, Paintbrush, AlertCircle, Github, Check } from "lucide-react";
                    ...
                    <AnimatePresence mode="wait">
                        {!isSuccess ? (
                            ...
                            >
                                ...
                                <h2 className="text-2xl font-black mb-4">Account Created!</h2>
                                ...
                                <motion.button
                                    ...
                                    className="w-full py-4 bg-green-600 hover:bg-green-500 text-white rounded-2xl font-bold shadow-lg shadow-green-600/20 flex items-center justify-center gap-2 transition-all"
                                >
                                    Go to Sign In
